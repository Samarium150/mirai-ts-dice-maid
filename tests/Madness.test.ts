...
describe("validate", () => {
    describe("madness", () => {
        describe("getSymptom", () => {
            ...
            describe("temporary", () => {
                test("normal", () => {
                    (utils.random as jest.Mock).mockReturnValueOnce(5).mockReturnValueOnce(1);
                    expect(Madness.getSymptom(MadnessType.temporary)).toEqual(
                        "疯狂发作-临时症状: 1d10=6\n昏厥：调查员当场昏倒.\n持续时间: 1d10=1轮"
                    );
                });
                test("phobia", () => {
                    (utils.random as jest.Mock).mockReturnValueOnce(8).mockReturnValueOnce(1).mockReturnValueOnce(7);
                    expect(Madness.getSymptom(MadnessType.temporary)).toEqual(
                        "疯狂发作-临时症状: 1d10=9\n恐惧症：\n具体症状: 1d100=8\n恐风症：对风的恐惧.\n持续时间: 1d10=1轮"
                    );
                });
                test("mania", () => {
                    (utils.random as jest.Mock).mockReturnValueOnce(9).mockReturnValueOnce(1).mockReturnValueOnce(0);
                    expect(Madness.getSymptom(MadnessType.temporary)).toEqual(
                        "疯狂发作-临时症状: 1d10=10\n狂躁症：\n具体症状: 1d100=1\n沐浴癖：执着于清洗自己.\n持续时间: 1d10=1轮"
                    );
                });
